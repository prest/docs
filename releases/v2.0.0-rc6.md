...
This was the final v2 release candidate before [v2.0.0](v2.0.0.md). See the [v2 RC changelog](README.md) for the full rc1–rc6 history.
...
> **Superseded in v2.0.0:** ([#974](https://github.com/prest/prest/pull/974)) auto-disables JWT instead of refusing startup. See [v2.0.0 release notes](v2.0.0.md) and [Changes since rc6](main-since-rc6.md).
