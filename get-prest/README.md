...
There are several ways of downloading pREST, some are listed below. If it is your first time, we recommend following [Deploying with Docker](../deployment/deploying-with-docker.md).
...
**v2.1.0** is the latest stable v2 release. It adds native MCP over HTTP at `/_mcp`. See the [release notes](../releases/v2.1.0.md), [MCP over HTTP](../get-started/mcp-over-http.md), and the [stdio adapter](../get-started/prest-mcp-adapter.md) for Cursor and Claude Desktop.

* **Binary:** [v2.1.0 assets](https://github.com/prest/prest/releases/tag/v2.1.0)
* **Docker:** `prest/prest:v2.1.0`
* **MCP adapter:** `brew install prest/tap/prest-mcp` or see [pREST MCP Adapter](../get-started/prest-mcp-adapter.md)
